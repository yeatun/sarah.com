            ...
            <div class="row">
                <div class="col-md-4 ">
                   ...
                   <img src="assets/images/team/team-1.jpg" alt="#" />
                        <div class="team-desc ">
                            <h4 class="mb-0 desc">ZAHIRUL ISLAM (TANBIR)</h4>
                            <p class="mb-1 desc">Managing Director</p>
                ...
                <div class="col-md-4 ">
                    ...
                    <img src="assets/images/team/team-2.jpg" alt="#" />
                        <div class="team-desc ">
                            <h4 class="mb-0 desc">MOHAMMAD JUMMAN</h4>
                            <p class="mb-1 desc">Operations Manager</p>
                            <ul class="list-inline mb-0 team-social-links">
                                <li class="list-inline-item">
                                    <a href="#">
                                        <i class="fab fa-facebook-f"></i>
                ...
                <div class="col-md-4 ">
                    ...
                    <img src="assets/images/team/team-3.jpg" alt="#" />
                        <div class="team-desc">
                            <h4 class="mb-0 desc">RICA BALLANO</h4>
                            <p class="mb-1 desc">Office Admin</p>
                            <ul class="list-inline mb-0 team-social-links">
                                <li class="list-inline-item">
                                    <a href="#">
                                        <i class="fab fa-facebook-f"></i>
                ...
                <div class="col-md-4 ">
                    ...
                    <img src="assets/images/team/team-4.jpg" alt="#" />
                        <div class="team-desc">
                            <h4 class="mb-0 desc">VINIA ROMERO ( AISHA )</h4>
                            <p class="mb-1 desc">Sales & Marketing Manager</p>
                            <ul class="list-inline mb-0 team-social-links">
                                <li class="list-inline-item">
                                    <a href="#">
                                        <i class="fab fa-facebook-f"></i>
                ...
                <div class="col-md-4 ">
                    ...
                    <img src="assets/images/team/team-5.jpg" alt="#" />
                        <div class="team-desc ">
                            <h4 class="mb-0 desc">MOHAMMAD KABIR (MUSA)</h4>
                            <p class="mb-1 desc">Field operations Supervisor</p>
                            <ul class="list-inline mb-0 team-social-links">
                                <li class="list-inline-item">
                                    <a href="#">
                                        <i class="fab fa-facebook-f"></i>
