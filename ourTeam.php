        ...
        <div class="container py-5 mt-30 team-margin" style="">
                        ...
                        <div class="col-sm-6 p-0 text-center">
                            <div class="h-100 d-flex flex-column justify-content-center bg-danger p-4">
                                ...
                                <div class="position-relative mb-2">
                                    <a class="btn btn-outline-light btn-square mr-1" href="https://www.facebook.com/photo/?fbid=109250378669412" target="_blank"><i class="fab fa-facebook-square"></i></a>
            ...
            <div class="row justify-content-lg-start m-0 mb-4 pb-2 mb-sm-0 pb-sm-0">
                <div class="col-lg-6 p-0 shadow" >
                    <div class="row m-0 ">
                        <div class="col-sm-6 p-0 text-center">
                            <div class="h-100 d-flex flex-column justify-content-center bg-danger p-4">
                                <h5 class="text-white bmb-2">SHARMIN AKHTER</h5>
                        ...
                        <div class="col-sm-6 p-0" style="min-height: 300px;">
                            <img class=" w-5 h-5" src="assets/images/team/team-10.jpg" style="object-fit: cover;">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-lg-end m-0">
                <div class="col-lg-6 p-0 shadow">
                    <div class="row m-0">
                        <div class="col-sm-6 p-0" style="min-height: 300px;">
                            <img class=" w-10 h-10" src="assets/images/team/team-11.jpg" style="object-fit: cover; ">
                        </div>
                        <div class="col-sm-6 p-0 text-center">
                            <div class="h-100 d-flex flex-column justify-content-center bg-danger p-4">
                                <h5 class="mb-2 text-white">KHADIJA AKTER</h5>
