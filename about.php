...
<html lang="en">
 ...
 <section class="features-area-3 light-bg1 pt-120 pb-130">
            <div class="features-bg bg_cover ml-auto" style="background-image: url(assets/images/bg/features-bg-5.jpg);"></div>
            <div class="container">
                <div class="row">
                    <div class="offset-lg-6 col-lg-8">
                        <div class="features-content-box">
                            ...
                            <p>Sahara Planner Co. W.L.L. is an event management & event manpower supplier company in
...
Our organization is an assembly of hardworking, experience, dynamic and dedicated profes-
sional working to provide quality and superior business solution. We provide very good profes-
sional services to our client. </p>
                              <br/>
                            <!-- <ul class="icon-list mb-50">
                                <li>Organizing.</li>
                                <li>Staffing and Providing Promoters, Supervisors.</li>
                                <li>Product Demonstration and Launch.</li>
                            </ul> -->
...
Creative is great but tangible results are even better.</p> <a href="#" class="main-btn">Learn More</a> </div>
               </div>
               <div class="col-md-7">
                  <div class="about_img">
                  ...
                  <div class="titlepage1">
                     ...
                     <p>Delivering results-oriented campaign that enhance our clients awareness, improve their
                      sales and foster their growth.
                       ...
                       <br>
                       <a href="#" class="main-btn">Learn More</a> </div>
               </div>
    ...
    <br>
       ...
       <!-- <section>
        <div><h1 class="text-center pt-20 pb-20">TESTIMONIAL</h1></div>
...
guarantees our consistently giving of our best in any project we undertake.</p>
        ...
        <div class="user">
            ...
            <div class="user-details">
                <h4 class="username">Zahirul Islam
</h4>
       ...
       <div class="testimonial-area">
		<div class="container">
			<div class="row">
                ...
                <br>
				<div id="carouselExampleIndicators" class="carousel slide testi" data-bs-ride="true">
